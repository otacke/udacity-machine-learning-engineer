...
class LearningAgent(Agent):
    ...
    def __init__(self, env):
        ...
        # final q table of best results,fect see report
    ...
    def q_learn(self, state, action, reward, next_state):
        ...
        # use reward as default value for the q table, not 0 - should make learning quicker
...
def run():
    ...
    # parameters for grid search #5
    #alphas   = [0.07, 0.1, 0.13]
    #gammas   = [0.07, 0.1, 0.13]
    #epsilons = [0.07, 0.1, 0.13]    
