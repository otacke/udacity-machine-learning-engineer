...
In an industry, success is not only measured in good critics, but the amount of money earned. In order to make decisions about future productions, publishers may want to predict the total revenues which they can expect after a new game has been released. Those decisions could possibly be based on historical data and a suitable regression model.
...
* https://www.kaggle.com/egrinstein/20-years-of-games/discussion 
